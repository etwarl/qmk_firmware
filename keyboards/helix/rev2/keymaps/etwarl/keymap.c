...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_GRV,  ADJUST,  WN_LGUI, WN_LALT, LOWER,   KC_CTSP, KC_SPC,  KC_BSPC, KC_ENT,  RAISE,   KC_EQL,  KC_LEFT, KC_DOWN, KC_RGHT\
      ),
  ...
  [_EUCALYN] = LAYOUT( \
      ...
      KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,\
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    TD(LBR), TD(RBR), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH,\
      KC_GRV,  KANA,    WN_LGUI, WN_LALT, LOWER, KC_CTSP, KC_SPC,  KC_BSPC, KC_ENT,  RAISE, KC_EQL,  KC_LEFT, KC_DOWN, KC_RGHT\
      ),
